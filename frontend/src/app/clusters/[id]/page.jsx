...
export default function Page({ params }) {
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mt-4 max-w-md text-base" style={{ color: theme.hint }}>
              The selected cluster item could not be found in your current library.
            </p>
          </div>
        </div>
      </main>
  ...
  return (
    <>
      <main className="min-h-[calc(100vh-81px)]" style={{ backgroundColor: theme.background, color: theme.foreground }}>
        <section className="mx-auto max-w-400 px-6 py-10 md:px-8">
          <div className="flex items-center justify-between">
            ...
            <button
              className="cursor-pointer text-2xl duration-200 hover:text-red-600"
            ...
            <div className="min-w-0 lg:flex-1">
              ...
              <div className="mt-6 max-w-3xl max-h-75 overflow-y-auto pr-2">
                <p className="wrap-break-word text-base leading-8" style={{ color: theme.hint }}>
                  {detailText || "This item is part of one of your current topic clusters."}
                </p>
              </div>
              ...
              <DetailRow label="Topic" value={item?.topicLabel} theme={theme} />
